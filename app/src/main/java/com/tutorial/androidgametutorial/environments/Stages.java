...
public enum Stages {
    ...
    private int[][] outsideArray;
    private ArrayList<int[][]> insideMaps;
    private ArrayList<Building> buildings;
    private ArrayList<GameObject> gameObjects;
    int NumOfOutsideEnemy, NumOfInsideEnemy;

    // Constructor
    Stages(int[][] outsideArray, ArrayList<int[][]> insideMaps, ArrayList<Building> buildings, ArrayList<GameObject> gameObjects, int NumOfOutsideEnemy, int NumOfInsideEnemy) {
